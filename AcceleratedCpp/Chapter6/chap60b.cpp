...
int main()
{
	...
	//needs to have optimistic_median_analysis written
...
//Answer: Compile using g++ median.cpp grade.cpp Student_info.cpp extract_fails.cpp chap60b.cpp -o chap60b.o